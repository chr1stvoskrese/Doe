...
Запароль весь vault **AES-256-GCM + scrypt**. Даже если кто-то получит твои файлы — без пароля они бесполезны. Можно разблокировать **Touch ID** на macOS. Твои данные, твои правила.
