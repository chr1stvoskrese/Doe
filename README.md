...
| ❌ Форки и изменения | Запрещены форки, модификации и производные работы |
...
**TL;DR:** Смотреть код и пользоваться приложением — можно. Форкать, копировать и зарабатывать на нём — нельзя.
