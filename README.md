...
| | |
|---|---|
| ✅ Просмотр кода | Читай, изучай, разбирайся, как всё устроено |
| ✅ Личное использование | Бесплатно запускай официальную сборку для себя |
| ❌ Форки и изменения | Нельзя форкать, модифицировать или делать производные работы |
| ❌ Распространение | Нельзя перевыкладывать код или приложение |
| ❌ Коммерция и клоны | Нельзя зарабатывать на коде и делать похожие/конкурирующие продукты |
| 💼 **Автор** | Все права у автора: проприетарные версии, платные функции (напр. Sync) — на его усмотрение |

**TL;DR:** Смотреть код и пользоваться приложением — можно. Форкать, копировать, зарабатывать на нём — нельзя. Модель как у Obsidian: проприетарный продукт, но с публично открытым исходником.
