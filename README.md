...
Doe распространяется под собственной **Doe Source-Available License** — это **проприетарная** лицензия с открытым для просмотра кодом. Код виден публично для прозрачности и изучения, но это **не** open source.

| Возможность | Условие |
|---|---|
| ✅ Просмотр кода | Читать и изучать исходный код в репозитории |
| ✅ Личное использование | Бесплатно запускать официальную немодифицированную сборку для себя |
| ✅ Вклад в проект | Форк и правки — чтобы предложить улучшение через pull request (права на вклад переходят правообладателю) |
| ❌ Самостоятельные форки | Запрещены форки, модификации и производные работы вне процесса pull request |
| ❌ Распространение | Запрещена повторная публикация кода или приложения |
| ❌ Коммерция и клоны | Запрещены коммерческое использование и похожие/конкурирующие продукты |
| 💼 Правообладатель | Сохраняет все права: проприетарные версии и платные функции — на своё усмотрение |

**TL;DR:** Смотреть код, пользоваться приложением и предлагать правки через pull request — можно. Самостоятельно форкать, копировать и зарабатывать на нём — нельзя.

**Pull requests приветствуются.** Форкай репозиторий, вноси правки и открывай PR — направляя вклад, ты соглашаешься, что права на него переходят правообладателю (см. раздел 6 лицензии). Принятие изменений — на усмотрение автора.
